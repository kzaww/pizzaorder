                        ...
                        @else
                            @foreach ($user as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item ->address  }}</td>
                                        <td>
                                            <a href="{{ route('admin#userDelete',$item->id) }}" onclick="return confirm('Are you sure?')"><button class="btn btn-sm bg-danger text-white"  title="delete"><i class="fas fa-trash-alt"></i></button></a>
                                        </td>
                                    </tr>
                            @endforeach
                        @endif
